...
jst._tmpl['event'] = function(event) {
    var __jst = '';
    __jst += '<tr class=\'event\' data-event-id="' + filter.html(event['id']) + '"> <td class=\'name-of-event\'><a href="events/' + filter.html(event['id']) + '">' + filter.html(event["name_of_event"]) + '</a></td> <td class=\'time\'>' + filter.html(event["start_of_event"] || "...") + '-' + filter.html(event["end_of_event"] || "...") + '</td> <td class=\'time\'><a href=\'/events/' + filter.html(event["id"]) + '/edit\' class=\'btn btn-outline-warning\'>Изменить</a></td> <td class=\'time\'><a href=\'/api/v1/events/' + filter.html(event["id"]) + '\' data-method="delete" data-confirm="Are you sure?" class=\'btn btn-outline-danger\' data-remote="true" data-event-id="' + filter.html(event['id']) + '">Удалить</a></td> </tr>';
...
jst._tmpl['no-results'] = '<p class=\'text-center font-weight-light font-italic god-thanks pt-2\'>Тут ничего.</p>';
